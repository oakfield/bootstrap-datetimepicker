 ...
 * =========================================================
 *
 * Modified 2017 by Michael Smith
 *
...
(function (factory) {
  ...
  var Datetimepicker = function (element, options) {
    ...
    this.component = this.element.is('.date')
      ? (this.bootcssVer == 3
        ? this.element
        .find('.input-group-addon .glyphicon-th, .input-group-addon .glyphicon-time, .input-group-addon .glyphicon-remove, .input-group-addon .fa-remove, .input-group-addon .glyphicon-calendar, .input-group-addon .fa-calendar, .input-group-addon .fa-clock-o').parent()
        : this.element
        .find('.add-on .icon-th, .add-on .icon-time, .add-on .icon-calendar, .add-on .fa-calendar, .add-on .fa-clock-o')
        .parent())
      : false;
    this.componentReset = this.element.is('.date')
      ? (this.bootcssVer == 3
        ? this.element
        .find('.input-group-addon .glyphicon-remove, .input-group-addon .fa-remove, .input-group-addon .fa-times').parent()
  ...
  Datetimepicker.prototype = {
    ...
    autoPosition: function (e) {
      var rect = $(this.picker)[0].getBoundingClientRect();
      var mouseLocation = e.originalEvent;
      var pos = "";
      if (mouseLocation.clientY + rect.height > window.innerHeight) {
        pos = "top-";
      } else {
        pos = "bottom-";
      }
      if (mouseLocation.clientX - rect.width < 0) {
        pos += "right";
      } else {
        pos += "left";
      }
    ...
    show: function (e) {
      ...
      $("#wrapper-nav").on('scroll', $.proxy(this.place, this));
      if (e) {
        e.stopPropagation();
        e.preventDefault();
      }
  ...
  $.fn.datetimepicker = function (option) {
    ...
    this.each(function () {
      ...
      if (!data) {
        $this
          .data('datetimepicker', (data = new Datetimepicker(this, $.extend({}, $.fn.datetimepicker.defaults, options))));
      }
  ...
  var DPGlobal = {
    ...
    parseDate: function (date, format, language, type, timezone) {
      ...
      var parts = date && date.toString().match(this.nonpunctuation) || [],
        ...
        parsed = {},
        setters_order = [
          'hh', 'h', 'ii', 'i', 'ss', 's', 'yyyy', 'yy', 'M', 'MM', 'm', 'mm', 'D', 'DD', 'd', 'dd', 'H', 'HH', 'p', 'P',
          'z', 'Z'
        ],
        setters_map = {
          hh: function (d, v) {
  ...
  DPGlobal.templateV3 = '<div class="datetimepicker">' +
    ...
    '</table>' +
    '</div>' +
    '<iframe class="ieiFrameFix" name="ieiframe"></iframe>' +
    '</div>';
